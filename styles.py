...
[class*="st-key-aw_verify"], [class*="st-key-aw_help_video"],
[class*="st-key-rg_help_video"], [class*="st-key-ib_help_video"],
[class*="st-key-hc_help_video"], [class*="st-key-th_help_video"],
[class*="st-key-aa_help_video"], [class*="st-key-ap_help_video"],
[class*="st-key-ar_help_video"], [class*="st-key-sig_help_video"],
[class*="st-key-dbg_help_video"],
...
/* ═══════════════════════════════════════════════
   PODCAST DASHBOARD — Workflow surfaces
═══════════════════════════════════════════════ */
.podcast-panel {
  background: #161B22;
...
.podcast-status-card {
  background: linear-gradient(180deg, rgba(22,27,34,0.98) 0%, rgba(16,21,28,0.98) 100%);
  border: 1px solid rgba(45,212,191,0.1);
  border-top: 2px solid rgba(45,212,191,0.28);
  border-radius: 14px;
  padding: 16px 18px;
  min-height: 112px;
  box-shadow: 0 6px 22px rgba(0,0,0,0.42);
}
.podcast-status-kicker {
  font-size: 10px;
  font-weight: 700;
...
.podcast-phase-chip.is-active {
  background: rgba(45,212,191,0.12);
  border-color: rgba(45,212,191,0.4);
  color: #2DD4BF;
}
.podcast-phase-chip.is-complete {
  background: rgba(196,158,60,0.12);
