...
class CreatorEvolutionTests(unittest.TestCase):
    ...
    def test_has_separate_state_and_route_contract(self):
        ...
        self.assertIn("Tuning Target", app_text)
        self.assertIn("What are you tuning?", app_text)
        self.assertIn("Voice style", app_text)
        self.assertIn("Format structure", app_text)
        self.assertIn("Voice only", app_text)
        self.assertIn("Format only", app_text)
        self.assertIn("Voice + format", app_text)
        self.assertIn("Pick Target", app_text)
        self.assertIn("Generate Preview", app_text)
        self.assertIn("Improve Tuned Voice", app_text)
        self.assertIn("Review And Apply", app_text)
