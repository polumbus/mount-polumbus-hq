...
class CreatorEvolutionTests(unittest.TestCase):
    ...
    def test_has_separate_state_and_route_contract(self):
        ...
        self.assertIn("Generate A/B Test", app_text)
        self.assertIn("Prompt to test", app_text)
        ...
        self.assertIn("Previous choice:", app_text)
        ...
        self.assertIn("HQ_EXTENSION_PROXY_KEY", Path("claude_proxy.py").read_text())
        self.assertIn("polumbus_hq_proxy_2026", Path("claude_proxy.py").read_text())
