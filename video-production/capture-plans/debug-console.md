# Debug Console Capture Plan

Page route:
`/?token=VIDEO_DEMO_TOKEN&user=owner&page=Debug+Console`
...
Exact selectors:
- `[data-video-id='debug-console-primary']`
- `main`
- `button`
- `textarea`
- `select`
...
Exact actions:
1. Open page in demo mode
2. Show fake health cards
3. Show no secrets
