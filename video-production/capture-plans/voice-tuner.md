# Voice Tuner Capture Plan

Page route:
`/?token=VIDEO_DEMO_TOKEN&user=owner&page=Voice+Tuner`
...
Exact selectors:
- `[data-video-id='voice-tuner-primary']`
- `main`
- `button`
- `textarea`
- `select`
...
2. Choose Promo
3. Generate A/B Test
4. Show A live and B sandbox
5. Open guided feedback
6. Show live controls collapsed
