# Fan Pulse Gameday Capture Plan

Page route:
`/?token=VIDEO_DEMO_TOKEN&user=owner&page=Fan+Pulse+Gameday`
...
Exact selectors:
- `[data-video-id='fan-pulse-gameday-primary']`
- `main`
- `button`
- `textarea`
- `select`
...
Exact actions:
1. Open page
2. Show live game topic
3. Review fan angle
4. Create timely post idea
