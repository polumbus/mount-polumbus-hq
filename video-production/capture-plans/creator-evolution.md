# Creator Evolution Capture Plan

Page route:
`/?token=VIDEO_DEMO_TOKEN&user=owner&page=Creator+Evolution`
...
Exact selectors:
- `[data-video-id='creator-evolution-primary']`
- `main`
- `button`
- `textarea`
- `select`
...
Exact actions:
1. Open page
2. Choose Normal Tweet
3. Choose Witty Edge
4. Paste raw idea
5. Generate options
6. Emphasize best option
