# Account Audit Capture Plan

Page route:
`/?token=VIDEO_DEMO_TOKEN&user=owner&page=Account+Audit`
...
Exact selectors:
- `[data-video-id='account-audit-primary']`
- `main`
- `button`
- `textarea`
- `select`
...
Exact actions:
1. Open page
2. Show audit categories
3. Highlight recommendation
