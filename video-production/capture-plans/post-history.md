# Post History Capture Plan

Page route:
`/?token=VIDEO_DEMO_TOKEN&user=owner&page=Post+History`
...
Exact selectors:
- `[data-video-id='post-history-primary']`
- `main`
- `button`
- `textarea`
- `select`
...
Exact actions:
1. Open page
2. Show previous posts
3. Filter or scroll
4. Highlight context value
