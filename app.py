...
AMPLIFIER_IMG = f'<span style="display:inline-block;width:20px;height:20px;border-radius:50%;background:url(data:image/png;base64,{AMPLIFIER_B64}) center/cover;vertical-align:middle;margin-right:4px;"></span>'
