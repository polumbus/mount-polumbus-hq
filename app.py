...
def page_compose_ideas():
    ...
    with _center:
        ...
        <div class="cs-icon-dock" style="display:flex;gap:8px;justify-content:center;margin-bottom:16px;">
          <div class="cs-idock-btn cs-idock-primary" data-dock="banger" title="Polish Your Draft Into A High-Performance Post" style="width:52px;height:52px;border-radius:14px;background:linear-gradient(135deg,#1fb8a8,#2DD4BF);display:flex;align-items:center;justify-content:center;cursor:pointer;position:relative;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" stroke="#060A12" stroke-width="2" stroke-linejoin="round"/></svg>
          ...
          <div class="cs-idock-btn" data-dock="build" title="Create Tweets From A Topic, Idea, Or Bullet Points" style="width:52px;height:52px;border-radius:14px;border:1px solid #1a2a45;background:#0a1220;display:flex;align-items:center;justify-content:center;cursor:pointer;position:relative;">
          ...
          <div class="cs-idock-btn" data-dock="rewrite" title="Remix Your Draft Into A New Format Or Angle" style="width:52px;height:52px;border-radius:14px;border:1px solid #1a2a45;background:#0a1220;display:flex;align-items:center;justify-content:center;cursor:pointer;position:relative;">
          ...
          <div class="cs-idock-btn" data-dock="grades" title="Grade Your Draft On Hook, Voice, And Viral Potential" style="width:52px;height:52px;border-radius:14px;border:1px solid #1a2a45;background:#0a1220;display:flex;align-items:center;justify-content:center;cursor:pointer;position:relative;">
        ...
        <div class="cs-bottom-bar" style="display:flex;gap:8px;justify-content:center;">
          <span class="cs-bot" data-bot="save" title="Save Draft To Your Idea Bank" style="height:52px;padding:0 18px;border-radius:14px;font-size:10px;font-weight:600;letter-spacing:0.04em;text-transform:uppercase;border:1px solid #1a2a45;background:#0a1220;color:#5a7090;cursor:pointer;display:inline-flex;align-items:center;gap:6px;">↓ Save</span>
          <span class="cs-bot" data-bot="bank" title="Open Your Saved Ideas And Inspiration Vault" style="height:52px;padding:0 18px;border-radius:14px;font-size:10px;font-weight:600;letter-spacing:0.04em;text-transform:uppercase;border:1px solid rgba(196,158,60,0.25);background:#0a1220;color:rgba(196,158,60,0.6);cursor:pointer;display:inline-flex;align-items:center;gap:6px;">Bank</span>
          <span class="cs-bot" data-bot="hot" title="Trending Topics And Fresh Tweet Ideas" style="height:52px;padding:0 18px;border-radius:14px;font-size:10px;font-weight:600;letter-spacing:0.04em;text-transform:uppercase;border:1px solid #1a2a45;background:#0a1220;color:#5a7090;cursor:pointer;display:inline-flex;align-items:center;gap:6px;">What\'s Hot</span>
          <span class="cs-bot" data-bot="post" title="Post Directly To X" style="height:52px;padding:0 18px;border-radius:14px;font-size:10px;font-weight:700;letter-spacing:0.04em;text-transform:uppercase;background:linear-gradient(135deg,#1fb8a8,#2DD4BF);color:#060A12;cursor:pointer;display:inline-flex;align-items:center;gap:6px;border:none;">𝕏 Post</span>
        </div>''', unsafe_allow_html=True)
    ...
    for i, t in enumerate(tweets_data):
        ...
        with rc3:
            ...
            st.markdown(f'''<div style="display:flex;gap:6px;margin-top:6px;">
              <div class="cs-bot" data-bot="rg_etg_{i}" style="width:40px;height:40px;border-radius:12px;border:1px solid #1a2a45;background:#0a1220;display:flex;align-items:center;justify-content:center;cursor:pointer;" title="Generate AI Reply Suggestion">
              ...
              {_liked_html}
              <div class="cs-bot" data-bot="rg_ets_{i}" style="width:40px;height:40px;border-radius:12px;background:linear-gradient(135deg,#1fb8a8,#2DD4BF);display:flex;align-items:center;justify-content:center;cursor:pointer;" title="Post Reply To X">
              ...
              <div class="cs-bot" data-bot="rg_etrd_{i}" style="width:40px;height:40px;border-radius:12px;border:1px solid #1a2a45;background:#0a1220;display:flex;align-items:center;justify-content:center;cursor:pointer;" title="Mark As Handled">
