...
def page_inspiration():
    ...
    if not filtered:
        ...
        for real_idx, item in filtered_with_idx:
            ...
            _use_style = "height:44px;padding:0 18px;border-radius:14px;font-size:12px;font-weight:600;letter-spacing:0.04em;text-transform:uppercase;background:#0a1220;border:1px solid rgba(45,212,191,0.3);color:#2DD4BF;cursor:pointer;display:inline-flex;align-items:center;text-decoration:none;margin-right:6px;"
            _rep_style = "height:44px;padding:0 18px;border-radius:14px;font-size:12px;font-weight:600;letter-spacing:0.04em;text-transform:uppercase;background:#0a1220;border:1px solid #1a2a45;color:#5a7090;cursor:pointer;display:inline-flex;align-items:center;text-decoration:none;margin-right:6px;"
