...
VOICE_TUNER_TEST_SCENARIOS = {
    "Witty Edge": (
        ...
        "The Nuggets keep saying flexibility but the non-Jokic minutes are still sitting there like the group project nobody wants to own.",
    ),
    "Comedic": (
        "The Nuggets bench minutes keep showing up like a group project where Jokic did all the slides and everyone else brought vibes.",
        "Broncos open competition is funny because fans have already convinced themselves every backup is secretly one training camp rep from Canton.",
        "The Rockies keep calling it development and the lineup keeps treating left handed pitching like a new DLC boss nobody downloaded.",
    ),
    "Annoyed": (
        "The Avs keep acting like the goalie conversation is settled and then one bad period sends everyone right back to the same exhausting argument.",
        "The Broncos keep saying every job is open but reputation still seems to get the first real chance, which is exactly the annoying part.",
        "The Nuggets keep explaining the rotation problem like the explanation is supposed to make the actual minutes less irritating.",
    ),
    "Fired-Up": (
        "The Broncos finally have camp energy that feels real, young guys are pushing, the defense looks fast, and this roster might actually have some bite.",
        "The Avs got one response shift and suddenly the whole bench looked like it remembered this series can still tilt back their way.",
        "The Nuggets can either treat that ugly ending like a scar or use it as the thing that finally forces a tougher roster.",
    ),
    "Skeptical": (
        "The Broncos can say the roster is deeper now but camp is where we find out if it is actual depth or just more average fighting for average.",
        "The Avs can call the goalie decision matchup based but one more switch makes it fair to ask if they actually trust anybody.",
        "The Nuggets can sell patience all summer but the bench problem keeps asking for proof instead of another clean quote.",
    ),
    "Critical": (
        "Sean Payton keeps saying competition matters, so camp needs to show which Broncos players still produce when reputation stops protecting them.",
        "The Nuggets front office can talk options all it wants, but if the rotation problem survives again then the critique gets pretty simple.",
        "The Avs can explain the goalie decision a dozen ways, but the process matters if one bad night turns into a confidence problem.",
    ),
    "Promo": (
        "Bo Nix looks on track for camp but there is one QB decision coming that tells you way more about how much Denver actually trusts the ankle.",
        "RJ Harvey might still have the title but Jonah Coleman does not need RB1 status to steal the Broncos snaps people will notice.",
        "The Avs goalie switch sounds simple until you notice the one bench tell that makes the whole thing feel less clean.",
    ),
    "Celebratory": (
        "The Avs finally got the kind of response game where the bench looks alive and the whole series suddenly feels less dead.",
        "The Broncos finally have young players pushing hard enough that camp competition feels like a strength instead of a press release.",
        "The Nuggets found one lineup stretch that made the building feel like it remembered what this team is supposed to be.",
    ),
    "Deadpan": (
        "The Rockies keep calling it a development year and then road series keep quietly submitting evidence to the contrary.",
        "The Broncos say every job is open, which is a calm way to announce several adults are about to have a bad August.",
        "The Avs goalie conversation is settled right up until the next save percentage graphic enters the chat.",
    ),
    "Sarcastic": (
        "The Broncos say every job is open, which is always comforting right before veterans discover the depth chart has stopped reading resumes.",
        "The Nuggets are open to everything this summer, which is excellent news for every problem except the one that keeps appearing when Jokic sits.",
        "The Avs goalie situation is totally calm, which explains why everyone keeps explaining how calm it is every fourteen minutes.",
    ),
}
